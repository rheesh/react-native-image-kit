/**
 * @overview Definition of CameraScreen component
 * for taking picture from camera.
 * This source was adapted from and inspired by expo Camera component example.
 * @see https://github.com/expo/camerja
 *
 * last modified : 2019.03.03
 * @module components/CameraScreen
...
*/
    ...
    onPictureSaved = ( photo ) => {
        if(this.props.onTakePhoto) return this.props.onTakePhoto(photo);
    };
    ...
    renderTopBar = () =>
        <View
            ...
            <TouchableOpacity style={styles.toggleButton} onPress={this.toggleWB}>
                <Icon type='MaterialIcons' name={wbIcons[this.state.whiteBalance]} style={{fontSize: 32, color: 'white'}} />
            </TouchableOpacity>
    ...
    renderBottomBar = () =>
        <View
            ...
            <TouchableOpacity style={styles.bottomButton} onPress={this.toggleMoreOptions}>
                <Icon type='Octicons' name="kebab-horizontal" style={{fontSize: 30, color: 'white'}} />
            </TouchableOpacity>
            <View style={{ flex: 0.4 }}>
                <TouchableOpacity
            ...
            <View style={styles.options}>
                <View style={styles.detectors}>
                    <TouchableOpacity onPress={this.toggleFaceDetection}>
                        <Icon type='MaterialIcons' name="tag-faces" style={{fontSize: 32, color: (this.state.faceDetecting ? "white" : "#858585") }} />
                    </TouchableOpacity>
                </View>
                <View style={styles.pictureSizeContainer}>
                    ...
                    <View style={styles.pictureSizeChooser}>
                        <TouchableOpacity onPress={this.previousPictureSize} style={{ padding: 6 }}>
                            <Icon type='Ionicons' name="md-arrow-dropleft" style={{fontSize: 14, color: 'white'}} />
                        </TouchableOpacity>
                        <View style={styles.pictureSizeLabel}>
                            <Text style={{color: 'white'}}>{this.state.pictureSize}</Text>
                        </View>
                        <TouchableOpacity onPress={this.nextPictureSize} style={{ padding: 6 }}>
                            <Icon type='Ionicons' name="md-arrow-dropright" style={{fontSize: 14, color: 'white'}} />
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
    ...
    render() {
        ...
        return <View style={[styles.container, {width:this.width}]}>{cameraScreenContent}</View>;
    }
}
